        ...
        <footer className="h-full">
                ...
                <div className="flex flex-col justify-center items-start">
                    ...
                    <span className="border border-white border-dashed w-full mb-[16px]" />
                    {
                        Object.keys(data).map((key, index) => (
                            <span key={index} className={`flex gap-1 text-2xl font-semibold ${inconsolate.className}`}>
            ...
            <div className={`w-full py-[10px] px-[16px] bg-primary ${lato.className} flex items-center justify-between`}>
                <div className="flex gap-2">
                    ...
                    <h4 className="font-bold text-2xl"> FOOSMeet &apos;25 </h4>
                </div>
                <span className="font-normal text-base"> An event conducted by FOSSCell NITC in collaboration with CSEA </span>
            </div>
        </footer>
    )
}
