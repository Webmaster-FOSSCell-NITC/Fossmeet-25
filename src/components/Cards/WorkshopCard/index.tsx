...
const WorkshopCard = ({
    ...
    return (
        <div className={`border border-secondary/25 shadow-lg p-0 w-[300px] flex flex-col justify-between ${lato.className}`}>
            ...
            <div className="py-[7px] px-[10px] overflow-hidden h-[225px] flex flex-col">
                <h2 className="text-[24px] font-bold text-gray-800 mb-[3px]">{title}</h2>
                <div className="flex items-center space-x-[8px] mb-[10px]">
                ...
                <div className="text-[#3B3B3BA6] text-[14px] overflow-y-auto max-h-[100px] pr-[5px] cursor-pointer">
                    {description}
                </div>
            </div>
